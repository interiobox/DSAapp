...
export const ListAttendanceResponseItem = zod.object({
  ...
  "status": zod.union([zod.literal('present'),zod.literal('late'),zod.literal('absent'),zod.literal('leave'),zod.literal('remote'),zod.literal(null)]).nullable(),
  "reason": zod.string().nullable(),
  "recordedBy": zod.number().nullable(),
  "recordedAt": zod.coerce.date().nullable(),
  "updatedAt": zod.coerce.date().nullable(),
  "latitude": zod.number().nullable(),
  "longitude": zod.number().nullable(),
  "accuracyMeters": zod.number().nullable(),
  "selfCheckinAt": zod.coerce.date().nullable()
})
 ...
 */
export const getMyAttendanceMonthQueryMonthRegExp = new RegExp('^[0-9]{4}-(0[1-9]|1[0-2])$');


export const GetMyAttendanceMonthQueryParams = zod.object({
  "month": zod.coerce.string().regex(getMyAttendanceMonthQueryMonthRegExp)
})

export const GetMyAttendanceMonthResponseItem = zod.object({
  "employeeId": zod.number(),
  "employeeName": zod.string(),
  "username": zod.string().nullable(),
  "attendanceDate": zod.coerce.date(),
...
export const GetMyAttendanceMonthResponse = zod.array(GetMyAttendanceMonthResponseItem)


/**
 * @summary Check in for the signed-in employee with location evidence
 */
export const selfCheckinAttendanceBodyLatitudeMin = -90;
export const selfCheckinAttendanceBodyLatitudeMax = 90;

export const selfCheckinAttendanceBodyLongitudeMin = -180;
export const selfCheckinAttendanceBodyLongitudeMax = 180;

export const selfCheckinAttendanceBodyAccuracyMetersMin = 0;
export const selfCheckinAttendanceBodyAccuracyMetersMax = 100000;



export const SelfCheckinAttendanceBody = zod.object({
  "attendanceDate": zod.coerce.date(),
  "workLocation": zod.enum(['office', 'remote']),
  "latitude": zod.number().min(selfCheckinAttendanceBodyLatitudeMin).max(selfCheckinAttendanceBodyLatitudeMax),
  "longitude": zod.number().min(selfCheckinAttendanceBodyLongitudeMin).max(selfCheckinAttendanceBodyLongitudeMax),
  "accuracyMeters": zod.number().min(selfCheckinAttendanceBodyAccuracyMetersMin).max(selfCheckinAttendanceBodyAccuracyMetersMax)
})

export const SelfCheckinAttendanceResponse = zod.object({
  "employeeId": zod.number(),
  "employeeName": zod.string(),
  "username": zod.string().nullable(),
  "attendanceDate": zod.coerce.date(),
...
export const RecordAttendanceParams = zod.object({
  "employeeId": zod.coerce.number().min(1)
})

export const RecordAttendanceBody = zod.object({
  "attendanceDate": zod.coerce.date(),
  "status": zod.enum(['present', 'late', 'absent', 'leave', 'remote']),
 ...
 */
export const AdminGetGoogleDriveStatusResponse = zod.object({
  "provider": zod.enum(['google_drive', 'object_storage']),
 ...
 */
export const AdminDisconnectGoogleDriveResponse = zod.void()
 ...
 */
export const AdminCompleteGoogleDriveOAuthQueryParams = zod.object({
  "code": zod.coerce.string().optional(),
  "state": zod.coerce.string().optional()
})

export const AdminCompleteGoogleDriveOAuthResponse = zod.void()
...
export const UploadDrawingToDriveParams = zod.object({
  "id": zod.coerce.number().min(1)
})

export const UploadDrawingToDriveHeader = zod.object({
  "X-File-Name": zod.string(),
  "X-File-Content-Type": zod.string()
})

export const UploadDrawingToDriveResponse = zod.object({
  "id": zod.number(),
  "drawingId": zod.number(),
  "filePath": zod.string(),
  "fileName": zod.string(),
 ...
 */
export const GetDriveFileParams = zod.object({
